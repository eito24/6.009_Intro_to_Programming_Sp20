...
class TestTiny(unittest.TestCase):
    ...
    def test_acted_together(self):
        ...
        actor_2_id=4025
        expected=False
        self.assertEqual(lab.acted_together(self.data,actor_1_id,actor_2_id),expected)
    def test_bacon_number_0(self):
        bacon_number=0
        expected={4724}
        self.assertEqual(lab.actors_with_bacon_number(self.data,bacon_number), expected)
    ...
    def test_bacon_number_3(self):
        ...
        expected=set()
        self.assertEqual(lab.actors_with_bacon_number(self.data,bacon_number), expected)        
    def test_baconpath_1(self):
        actor_id=4724
        expected=[4724,2876,1640]
        self.assertEqual(lab.bacon_path(self.data,1640), expected)
    def test_actorspath_1(self):
        actor_1_id=1532
        actor_2_id=1640
        expected=[1532,2876,1640]
        self.assertEqual(lab.actor_to_actor_path(self.data,1532,1640), expected)        
